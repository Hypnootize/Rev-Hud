Scheme
{
	...
	/////////////////////////////////////////////////////////////////////////////
	// BUDHUD COLORS (edited for RevHUD)
	...
	/////////////////////////////////////////////////////////////////////////////	
		...
		// Health
			...
			"bh_HealthLow"			"255 255 255 255"
			"bh_HealthBuff"			"255 255 255 255"
			"bh_HealthPickup"		"50 200 50 255"
		
		// Ammo
			"bh_AmmoInClip"			"255 255 255 255"
			"bh_AmmoReserve"		"51 151 213 255"
			"bh_LowAmmoPulse"		"187 187 187 255" 	// Ammo color when ammo is low
		...
		// Damage Done & Heals Given
			...
			"bh_HealColor"			"51 151 213 255" 	// Medigun/arrow heals
			
		// Full Uber Flash
			"bh_chargecolor1"		"51 151 213 255"	// When full, uber will change between these two values
			"bh_chargecolor2"		"0 119 255 255"
			"bh_chargemeter"		"255 255 255 255"	// Default uber chargemeter fill color
		
		// whayay's Crosshairs
			"ya_crosshair"			"255 255 255 255" 	// Crosshair color
			"ya_xhairflash"			"51 151 213 255"	// Flash on damage done
		
		// Fog's Crosshairs
			"fog_crosshair"			"255 255 255 255"	// Crosshair color
		
		// statsummary colors
			"bh_Bar1"						"15 255 255 128"
			"bh_Bar2"						"15 225 225 128"
			"bh_Bar3"						"15 195 195 128"
			"bh_Bar4"						"15 165 165 128"
			"bh_Bar5"						"15 135 135 128"
			"bh_Bar6"						"15 105 105 128"
			"bh_Bar7"						"15 85 85 128"
			"bh_Bar8"						"15 65 65 128"
			"bh_Bar9"						"15 45 45 128"
		...
		// budhud core colors
			...
			"bh_lorange"			"75 0 130 255"
			"bh_dorange"			"159 0 255 255"
			"bh_deeorange"			"228 144 000 255"
			"bh_orange"				"51 151 213 255"
			"bh_green"				"0 215 0 255"
			"bh_red"				"255 40 40 255"
			"bh_blue"				"0 135 215 255"
		...
		"DisguiseMenuIconBlue"		"92 128 166 255"
 		...
 		"MatchmakingDialogTitleColor"			"51 151 213 255"		// bh_orange
 		"MatchmakingMenuItemBackground"			"46 43 42 255"
 		"MatchmakingMenuItemBackgroundActive"	"51 151 213 255"		// bh_orange
		"MatchmakingMenuItemTitleColor"			"51 151 213 255"		// bh_orange
	...
	Borders
	{
		...
		StoreNewBorder
		// As advertised. Yellow "NEW!" text in store.
		// 100 doesn't even look that bad
		{
			"bordertype"			"scalable_image"
			"backgroundtype"		"2"
	...
	CustomFontFiles
	{
		...
		"16"
		{
			"font" "resource/fonts/SlatePro-BoldCondensed.otf"
			"name" "Slate Pro Condensed"
		}
		"17"
		{
			"font" "resource/fonts/FiraSans-Medium.otf"
